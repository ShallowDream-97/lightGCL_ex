...
def parse_args():
    ...
    parser.add_argument('--eps_1', default=0.1, type=float, help='temperature in cl loss')
    parser.add_argument('--eps_2', default=0.1, type=float, help='temperature in cl loss')
    parser.add_argument('--eps_3', default=0.1, type=float, help='temperature in cl loss')
