...
python main.py --cuda 0 --data gowalla --temp 0.3 --lambda2 0 --dropout 0 > out_gow & 
python main.py --cuda 0 --data gowalla --temp 0.3 --lambda1 1e-6 --lambda2 0 --dropout 0 > out_gow 