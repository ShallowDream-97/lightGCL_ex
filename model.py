        ...
        if test==True:  # testing phase
            ...
            for i in range(len(uids)):
                ...
                for p_item, n_item in zip(u_pos, u_neg):
                    ...
                    item_category = pop_list[p_item.cpu().numpy()]  # 注意将Tensor转为numpy对象以进行索引
            ...
            loss_r_pop = loss_pop
            loss_r_mid = loss_mid
            loss_r_unpop = loss_unpop
            
            loss_r = loss_r_pop + loss_r_mid + loss_r_unpop
            loss_r = loss_r/(count_pop + count_mid + count_unpop)
